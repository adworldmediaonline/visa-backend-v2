...
import EthiopiaGovRefDetails from '../../models/ethiopia/ethiopiaGovRefDetailsModel.js';
...
const createOrUpdateGovRefDetails = expressAsyncHandler(async (req, res) => {
    try {
        ...
        govRefDetails = await EthiopiaGovRefDetails.findOne(query);

        if (!govRefDetails) {
            govRefDetails = new EthiopiaGovRefDetails({
                visaApplicationId: applicationId,
                applicationType: applicantType,
...
const getGovRefDetails = expressAsyncHandler(async (req, res) => {
    try {
        ...
        const govRefDetails = await EthiopiaGovRefDetails.findOne(query);
...
const deleteGovRefDetails = expressAsyncHandler(async (req, res) => {
    try {
        ...
        await EthiopiaGovRefDetails.findByIdAndDelete(govRefDetails._id);
