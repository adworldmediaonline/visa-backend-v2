...
const ethiopiaVisaApplicationController = {
    ...
    try {
      ...
      const applicantsDetails = {
        ...
        additionalApplicants:
          ethiopiaVisaApplication.additionalApplicants || [],
        totalApplicants:
          1 + (ethiopiaVisaApplication.additionalApplicants?.length || 0),
      };
  ...
  updateEthiopiaVisaApplication: async (req, res) => {
    try {
      ...
      const ethiopiaVisaApplication =
        await EthiopiaVisaApplication.findByIdAndUpdate(id, updateData, {
          new: true,
        });
  ...
  deleteEthiopiaVisaApplication: async (req, res) => {
    try {
      ...
      const ethiopiaVisaApplication =
        await EthiopiaVisaApplication.findByIdAndDelete(id);
